...
HD_PWD='C:/Users/johns/Documents/Digital System Design/Personal/dsd/Projects/asteroids/asteroids.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log asteroids.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source asteroids.tcl
