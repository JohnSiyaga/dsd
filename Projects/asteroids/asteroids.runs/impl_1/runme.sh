...
HD_PWD='C:/Users/johns/Documents/Digital System Design/Personal/dsd/Projects/asteroids/asteroids.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log asteroids.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source asteroids.tcl -notrace
